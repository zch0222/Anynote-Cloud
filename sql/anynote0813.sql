...
CREATE TABLE `sys_menu` (
  ...
  `path` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '前端路由地址',
  ...
  `perms` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '后端地址',
...
CREATE TABLE `sys_role` (
  ...
  `role_name` char(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色名称',
  `role_key` char(10) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色权限字符串',
  `role_sort` int NOT NULL COMMENT '显示顺序',
  `data_scope` char(1) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '数据范围（1：全部数据权限 2：自定数据权限 3：本部门数据权限 4：本部门及以下数据权限）',
  `status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '角色状态',
  `is_delete` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除标记，1表示删除，0表示未删除',
  `create_by` char(15) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` char(15) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `sys_user` (
  ...
  `phone_number` char(11) COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '手机号码',
...
-- Dump completed on 2023-08-13 22:11:35
