...
INSERT INTO `config_info` VALUES (1,'anynote-gateway-dev.yml','DEFAULT_GROUP','spring:\n  redis:\n    host: localhost\n    port: 6379\n    password:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          lowerCaseServiceId: true\n          enabled: true\n    routes:       \n      - id: anynote-system\n        uri: lb://anynote-system\n        predicates:\n          - Path=/api/system/**\nanynote:\n  module:\n    name: \'anynote-gateway1\'\n\n# 测试属性\nruoyi:\n  # 名称\n  name: RuoYi\n  # 版本\n  version: 1.0.0\n\n# 安全配置\nsecurity:\n  # 验证码\n  captcha:\n    enabled: true\n    type: math\n  # 防止XSS攻击\n  xss:\n    enabled: true\n    excludeUrls:\n      - /system/notice\n  # 不校验白名单\n  ignore:\n    whites:\n      - /auth/logout\n      - /auth/login\n      - /auth/register\n      - /*/v2/api-docs\n      - /csrf','e18a31ed24295fc23966a976ed099bf7','2023-07-26 03:10:00','2023-07-27 09:13:09','','192.168.186.1','','0587fa28-1301-43db-a7a1-599c00fc3f70','','','','yaml','',''),(9,'anynote-system-dev.yml','DEFAULT_GROUP','# 数据库配置\r\nspring:\r\n  datasource:\r\n    type: com.alibaba.druid.pool.DruidDataSource\r\n    driverClassName: com.mysql.cj.jdbc.Driver\r\n    url: jdbc:mysql://localhost:3306/kindergarten?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8\r\n    username: root\r\n    password: 123456','2c704c607ebdeb3d8ef81d5c5dbb2996','2023-07-27 08:56:01','2023-07-27 08:56:01',NULL,'192.168.186.1','','0587fa28-1301-43db-a7a1-599c00fc3f70',NULL,NULL,NULL,'yaml',NULL,'');
...
-- Dump completed on 2023-07-28  2:56:06
